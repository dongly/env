...
def show_version():
    ...
    print('╔═══════════════════════════════════════════════════════════════════════════╗')
    print('║' + ' ' * 77 + '║')
    print('║' + f'  Welcome to {rt_env_name} v{rt_env_ver}'.center(77) + '║')
    print('║' + ' ' * 77 + '║')
    print('╠═════════════════════════════════════════════════════════════════════════╣')
    print('║' + ' ' * 77 + '║')
    print('║' + '  Environment Information:'.ljust(77) + '║')
    print('║' + ' ' * 77 + '║')
    print('║' + f'    • ENV_ROOT    : {get_env_root()}'.ljust(77) + '║')
    print('║' + f'    • PKGS_ROOT   : {get_package_root()}'.ljust(77) + '║')
    print('║' + f'    • BSP_ROOT    : {get_bsp_root()}'.ljust(77) + '║')
    if rtt_ver != (0, 0, 0):
        print('║' + f'    • RT-Thread   : {rtt_ver[0]}.{rtt_ver[1]}.{rtt_ver[2]}'.ljust(77) + '║')
    print('║' + ' ' * 77 + '║')
    print('╚═════════════════════════════════════════════════════════════════════════╝')
    print('')
